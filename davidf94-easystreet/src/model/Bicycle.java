...
public class Bicycle extends AbstractVehicle {
    ...
    /**
     * Constructor for a Bicycle vehicle.
     * 
    ...
    public boolean canPass(final Terrain theTerrain, final Light theLight) {
        ...
        if (theTerrain.equals(Terrain.TRAIL)) {
            result = true;
        } else if (theTerrain.equals(Terrain.STREET)) {
            result = true;
    ...
    public Direction chooseDirection(final Map<Direction, Terrain> theNeighbors) {
        ...
        while (!goodD) {
            if (theNeighbors.get(dir) == Terrain.TRAIL) { //checks for trail
                goodDir = dir;
                goodD = true;
            } else if (theNeighbors.get(dir.left()) == Terrain.TRAIL) {
                goodDir = dir.left();
                goodD = true;
            } else if (theNeighbors.get(dir.right()) == Terrain.TRAIL) {
                goodDir = dir.right();
                goodD = true;
              //checks straight for street or light
            } else if (theNeighbors.get(dir) == Terrain.STREET) { 
                goodDir = dir;
                goodD = true;
            } else if (theNeighbors.get(dir) == Terrain.LIGHT) {
                goodDir = dir;
                goodD = true;
                //checks left for street or light
                ...
                goodDir = dir.left();
                goodD = true;
                //checks right for street or light
