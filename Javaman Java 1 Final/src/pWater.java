...
public class pWater {
	...
	private Abilities move1 = new Abilities("Pound", "normal", 5, null);
	private Abilities move2 = new Abilities("Water Gun", "water", 4, null);
	private Abilities move3 = new Abilities("Whirlpool", "water", 6, null);
	private Abilities move4 = new Abilities("Tsunami", "water", 8, null);
	
	public pWater(String name){
		this.name = name;
		moveSet.add(move1);
	}
